...
const Router = (function() {
    ...
    function renderOrganizePdf() {
        showPage('tool');
        if (typeof OrganizePdfToolController !== 'undefined' && OrganizePdfToolController.render) {
            OrganizePdfToolController.render();
        } else {
            showError('Organize PDF tool not loaded');
        }
    }
    ...
    function renderImageConverter() {
        showPage('tool');
        if (typeof ImageConverterToolController !== 'undefined' && ImageConverterToolController.render) {
            ImageConverterToolController.render();
        } else {
            showError('Image Converter tool not loaded');
        }
    }

    function renderImageEditor() {
        showPage('tool');
        if (typeof ImageEditorToolController !== 'undefined' && ImageEditorToolController.render) {
            ImageEditorToolController.render();
        } else {
            showError('Image Editor tool not loaded');
        }
    }
